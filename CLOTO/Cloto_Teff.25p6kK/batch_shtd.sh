...
setenv ATOMIC ~/CMFGEN/atomic
setenv atomic ~/CMFGEN/atomic
setenv CMFGEN_PROG ~/CMFGEN/cur_cmf/exe/cmfgen_dev.exe
...
#*****************************************************************************
 ...
 ln -sf  $ATOMIC/MG/II/5aug97/mg2_f_to_s_term.dat         Mg2_F_TO_S
...
#
 ...
 ln -sf  $ATOMIC/AL/III/5aug97/aliii_f_to_s_term.dat      AlIII_F_TO_S
...
#
 ln -sf  $ATOMIC/SIL/III/5dec96/phot_op.dat                 PHOTSkIII_A
 ln -sf  $ATOMIC/SIL/III/5dec96/osc_op_split_rev.dat        SkIII_F_OSCDAT
 ln -sf  $ATOMIC/SIL/III/5dec96/f_to_s_split.dat            SkIII_F_TO_S
 ln -sf  $ATOMIC/SIL/III/5dec96/col_guess.dat               SkIII_COL_DATA
#
 ln -sf  $ATOMIC/SIL/IV/5dec96/phot_op.dat                 PHOTSkIV_A
# ln -sf  $ATOMIC/SIL/IV/5dec96/osc_op_split.dat_test            SkIV_F_OSCDAT
